...
pub trait Guest {
    ...
    fn metadata(ctx: Ctx) -> ::core::result::Result<RouteMeta, RouteError>;
    #[allow(async_fn_in_trait)]
    fn lookup(ctx: Ctx) -> ::core::result::Result<Entry, RouteError>;
    #[allow(async_fn_in_trait)]
    fn list(ctx: Ctx) -> ::core::result::Result<_rt::Vec<Entry>, RouteError>;
    #[allow(async_fn_in_trait)]
    fn read(ctx: Ctx) -> ::core::result::Result<_rt::Vec<u8>, RouteError>;
    #[allow(async_fn_in_trait)]
    fn write(ctx: Ctx, body: _rt::Vec<u8>) -> ::core::result::Result<(), RouteError>;
}
#[doc(hidden)]
#[macro_export]
...
pub mod bloom {
    pub mod chain {
        ...
        pub mod read {
            ...
            #[allow(async_fn_in_trait)]
            pub fn call(req: &Request) -> ::core::result::Result<Response, _rt::String> {
                unsafe {
    ...
    pub mod env {
        ...
        pub mod runtime {
            ...
            #[allow(unused_unsafe, clippy::all)]
            #[allow(async_fn_in_trait)]
            pub fn now_ms() -> ::core::result::Result<u64, _rt::String> {
                unsafe {
                    #[repr(align(8))]
                    struct RetArea(
                        [::core::mem::MaybeUninit<
            ...
            pub fn random_bytes(
                len: u32,
            ) -> ::core::result::Result<_rt::Vec<u8>, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
    ...
    pub mod http {
        ...
        pub mod fetch {
            ...
            pub fn fetch(
                req: &Request,
            ) -> ::core::result::Result<Response, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
    ...
    pub mod route {
        ...
        pub mod types {
            ...
            pub struct Ctx {
                ...
                pub actor: ::core::option::Option<_rt::String>,
            }
            ...
            pub struct Entry {
                ...
                pub link_target: ::core::option::Option<_rt::String>,
            }
            ...
            pub struct RouteMeta {
                pub kind: EntryKind,
                pub mode: u32,
                pub cache_ttl_ms: ::core::option::Option<u64>,
                pub side_effecting_read: bool,
                pub write_async: bool,
                pub description: ::core::option::Option<_rt::String>,
                pub consent_summary: ::core::option::Option<_rt::String>,
                pub required_caps: _rt::Vec<_rt::String>,
                pub sign_intent: ::core::option::Option<_rt::String>,
                pub executable: bool,
            }
    ...
    pub mod sign {
        ...
        pub mod signing {
            ...
            pub struct PayloadSignRequest {
                ...
                pub claim_assurance_evidence: ::core::option::Option<_rt::Vec<u8>>,
                pub approval_hint: ::core::option::Option<_rt::String>,
                pub action: ::core::option::Option<_rt::Vec<u8>>,
                pub advisory: ::core::option::Option<_rt::Vec<u8>>,
                pub selector: Selector,
                pub key_ref_jcs: ::core::option::Option<_rt::Vec<u8>>,
            }
            ...
            ) -> ::core::result::Result<SignResult, _rt::String> {
                unsafe {
                    #[repr(align(8))]
                    struct RetArea(
                        [::core::mem::MaybeUninit<
            ...
            ) -> ::core::result::Result<SignBatchResult, _rt::String> {
                unsafe {
                    #[repr(align(8))]
                    struct RetArea(
                        [::core::mem::MaybeUninit<
    ...
    pub mod store {
        ...
        pub mod kv {
            ...
            pub fn list(
                namespace: &str,
                prefix: &str,
            ) -> ::core::result::Result<_rt::Vec<_rt::String>, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
    ...
    pub mod tx {
        ...
        pub mod outbox {
            ...
            pub struct EvmTransaction {
                ...
                pub max_fee_per_gas: ::core::option::Option<_rt::String>,
                pub max_priority_fee_per_gas: ::core::option::Option<_rt::String>,
            }
            ...
            pub struct StagedTransaction {
                ...
                pub approval: ::core::option::Option<ApprovalRequired>,
            }
            ...
            pub struct Inspection {
                ...
                pub tx_hash: ::core::option::Option<_rt::String>,
                pub receipt_json: ::core::option::Option<_rt::String>,
            }
            ...
            pub fn stage(
                tx: &EvmTransaction,
            ) -> ::core::result::Result<StagedTransaction, _rt::String> {
                unsafe {
                    #[repr(align(8))]
                    struct RetArea(
                        [::core::mem::MaybeUninit<
            ...
            pub fn inspect(
                ...
                chain: &str,
                outbox_id: &str,
            ) -> ::core::result::Result<Inspection, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
    ...
    pub mod vfs {
        ...
        pub mod readwrite {
            ...
            #[allow(unused_unsafe, clippy::all)]
            #[allow(async_fn_in_trait)]
            pub fn lookup(path: &str) -> ::core::result::Result<Entry, _rt::String> {
                unsafe {
                    #[repr(align(8))]
                    struct RetArea(
                        [::core::mem::MaybeUninit<
            ...
            pub fn list(
                path: &str,
            ) -> ::core::result::Result<_rt::Vec<Entry>, _rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
...
macro_rules! __export_route_file_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.61.1:bloom:route@0.1.0:route-file:imports and exports")]
...
\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.258.0\x10wit-bind\
gen-rust\x060.61.1";
        };
    };
}
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.61.1:bloom:route@0.1.0:route-file-with-all-of-its-exports-removed:encoded world"
)]
#[doc(hidden)]
...
d\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.258.0\x10\
wit-bindgen-rust\x060.61.1";
#[inline(never)]
#[doc(hidden)]
