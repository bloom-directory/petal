...
pub mod sdk {
    pub use super::{
        ...
        PayloadSignRequest, PetalKeyOutcome, PetalKeyRequest, PrivateInputKind,
        PrivateInputOutcome, PrivateInputRequest, SdkError, SignBatchOutcome, SignOutcome,
        SignSelector, StagedTransaction, payload_batch_digest,
    };
